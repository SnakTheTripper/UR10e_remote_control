...
def ur10e_platform_variables(idx, objects):
    ...
    joint_speed = control.add_variable(idx, "Joint Speed", 0.1)
    joint_accel = control.add_variable(idx, "Joint Acceleration", 0.1)
    tcp_speed = control.add_variable(idx, "TCP Speed", 0.1)
    tcp_accel = control.add_variable(idx, "TCP Acceleration", 0.1)
    is_moving = control.add_variable(idx, "is_moving", False)
    ...
    input_bit_0 = digital_inputs.add_variable(idx, "input bit 0", False)
    input_bit_1 = digital_inputs.add_variable(idx, "input bit 1", False)
    input_bit_2 = digital_inputs.add_variable(idx, "input bit 2", False)
    input_bit_3 = digital_inputs.add_variable(idx, "input bit 3", False)
    input_bit_4 = digital_inputs.add_variable(idx, "input bit 4", False)
    input_bit_5 = digital_inputs.add_variable(idx, "input bit 5", False)
    input_bit_6 = digital_inputs.add_variable(idx, "input bit 6", False)
    input_bit_7 = digital_inputs.add_variable(idx, "input bit 7", False)
    ...
    output_bit_0 = digital_outputs.add_variable(idx, "output bit 0", False)
    output_bit_1 = digital_outputs.add_variable(idx, "output bit 1", False)
    output_bit_2 = digital_outputs.add_variable(idx, "output bit 2", False)
    output_bit_3 = digital_outputs.add_variable(idx, "output bit 3", False)
    output_bit_4 = digital_outputs.add_variable(idx, "output bit 4", False)
    output_bit_5 = digital_outputs.add_variable(idx, "output bit 5", False)
    output_bit_6 = digital_outputs.add_variable(idx, "output bit 6", False)
    output_bit_7 = digital_outputs.add_variable(idx, "output bit 7", False)
